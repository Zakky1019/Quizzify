...
<div class="change-password-container">
    ...
    <div class="return-button">
        <a href="http://localhost/Quizzify/Quizzify/Interface/php_files/user_profile.php">Return to User Profile</a>
    </div>
...
<script>
    ...
    if (confirmation) {
        ...
        document.querySelector(".change-password-form").action = "http://localhost/Quizzify/Quizzify/ui/change_password_script.php?User_Id=<?php echo $_GET['User_Id']; ?>";
