    ...
    $query = "SELECT Username, FirstName, LastName,Instructor_Id,Email,profile_picture FROM instructor WHERE Instructor_Id = :id";
      ...
      <main class="profile-container" style="padding-top: 150px;">
        <section class="user-details">
            <div class="left-section">
                <img src="idisplay_profile_picture.php" alt="Profile Picture">
            </div>
          <div class="middle-section">
        <h2><?php echo $userDetails['Username']; ?></h2>
            
        <p>User ID: <?php echo $userDetails['Instrcutor_Id']; ?></p>
        ...
        <p>Email: <?php echo $userDetails['Email']; ?></p>
          ...
          <div class="right-section">
            <button class="edit-btn" onclick="window.location.href = 'ieditprofile.php'">Edit Profile</button>
