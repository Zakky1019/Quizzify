...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Interface/ins1.css">
...
<?php
  ...
  <a href='instructoredit.php?edit=<?php echo $uid ?>' class="text-light">Edit</a>
</button>

     <button class="btn btn-danger"> <a href='instructor delete.php?del=<?php echo $uid ?>' class="text-light">Delete </a> </button> 
