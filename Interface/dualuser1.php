...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Interface/dualu.css">
...
<button class="btn btn-success">
    <a href='dualuseredit.php?edit=<?php echo $uid ?>' class="text-light">Edit</a>
</button>
<button class="btn btn-danger">
        <a href='dualuser delete.php?del=<?php echo $uid ?>' class="text-light">Delete</a>
    </button>
</div>
