...
<!DOCTYPE html>
    ...
    <div class="edit-profile-container" style="padding-top: 50px;">
        <h2>Edit Profile</h2>
        <form class="edit-profile-form" action="pdisplay_profile_picture.php" method="post" enctype="multipart/form-data">
            <!-- Include the User_Id in a hidden input field -->
            <input type="hidden" name="Participant_Id" value="<?php echo isset($userID) ? $userID : ''; ?>">
