    ...
    $query = "SELECT Username, FirstName, LastName,Participant_Id,Email,profile_picture FROM participant WHERE Participant_Id = :id";
...
.get-started:hover {
    ...
    <body>
        ...
        <nav>
            ...
            ?>
                    <a href="../Profile/user_profile.php" class="get-started"><?php echo $_SESSION["username"]; ?></a>
                <?php
                } elseif ($_SESSION["user_type"] === "participant") {

                ?>
                    <a href="../participantprofile/participantprofile.php" class="get-started"><?php echo $_SESSION["username"]; ?></a>
                <?php
                } elseif ($_SESSION["user_type"] === "instructor") {

                ?>
                    <a href="../intructor/iuser_profile.php" class="get-started"><?php echo $_SESSION["username"]; ?></a>
                <?php
                }
            } else {
      ...
      <main class="profile-container" style="padding-top: 150px;">
        <section class="user-details">
            <div class="left-section">
                <img src="pdisplay_profile_picture.php" alt="Profile Picture">
            </div>
          <div class="middle-section">
        <h2><?php echo $userDetails['Username']; ?></h2>
            
        <p>User ID: <?php echo $userDetails['Participant_Id']; ?></p>
        ...
        <p>Email: <?php echo $userDetails['Email']; ?></p>
          ...
          <div class="right-section">
            <button class="edit-btn" onclick="window.location.href = 'peditprofile.php'">Edit Profile</button>


              <button class="change-pwd-btn" onclick= "window.location.href = 'reset_pwd.php'">Change Password</button>
              <br>
      ...
      <script>
        function redirect1() {
                 window.location.href = 'http://localhost/Quizzify/php_files/peditprofile.php';
            }

            function redirect2() {
                window.location.href = 'http://localhost/Quizzify/Quizzify/ui/pchange_psw.php';
            }
      </script>
    </body>
    </html>
